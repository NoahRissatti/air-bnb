      ...
      >
        <Flex direction={"column"} w={{ base: "100%", md: "60%" }} gap={"12px"}>
          ...
          <Text fontSize={"lg"} fontWeight={400}>
            Nessa etapa, você adicionará algumas das comodidades que sua
            acomodação oferece, além de 5 fotos ou mais. Depois, você deverá
            criar um título e uma descrição.
          </Text>
        </Flex>
